 ...
 */
package com.fingerbeat.utilcode.utils.openfloatwindow;
...
import com.fingerbeat.utilcode.utils.rom.RomUtils;
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Logger.e(TAG, "ROM:360, user manually refuse OVERLAY_PERMISSION");
                }
            }
        });
    }
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Logger.e(TAG, "ROM:huawei, user manually refuse OVERLAY_PERMISSION");
                }
            }
        });
    }
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Logger.e(TAG, "ROM:meizu, user manually refuse OVERLAY_PERMISSION");
                }
            }
        });
    }
        ...
        showConfirmDialog(context, new OnConfirmResult() {
            ...
            public void confirmResult(boolean confirm) {
                if (confirm) {
                    ...
                    Logger.e(TAG, "ROM:miui, user manually refuse OVERLAY_PERMISSION");
                }
            }
        });
    }
