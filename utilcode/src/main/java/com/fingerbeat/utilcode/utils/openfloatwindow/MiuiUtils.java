    ...
    public static int getMiuiVersion() {
        ...
        if (version != null) {
            try {
                ...
                Logger.e(TAG, "get miui version code error, version : " + version);
...
//            }
    ...
    private static boolean checkOp(Context context, int op) {
        ...
        if (version >= 19) {
            ...
            Logger.e(TAG, "Below API 19 cannot invoke!");
        }
        return false;
    }
    ...
    public static void applyMiuiPermission(Context context) {
        ...
        if (versionCode == 5) {
            ...
            Logger.e(TAG, "this is a special MIUI rom version, its version code " + versionCode);
        }
    }
    ...
    public static void goToMiuiPermissionActivity_V5(Context context) {
        ...
        if (isIntentAvailable(intent, context)) {
            ...
            Logger.e(TAG, "intent is not available!");
        }
